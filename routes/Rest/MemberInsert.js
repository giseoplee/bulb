...
router.post('/', function(req, res, next) {
  ...
  connection.query("select id from users where application_id=? and registration_key=?",[req.body.application_id, req.body.registration_key], function(error, cursor){
    if(cursor.length > 0){
